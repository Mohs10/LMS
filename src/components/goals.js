...
namee: localStorage.getItem('username'),
    ...
    setIsNModalOpen(false)
        ...
        axios.post('http://localhost/LMS/src/php/goals.php', sendData)
        .then((result) => {
...
useEffect(() => {
    const fetchGoalData = async () => {
        ...
        axios.get('http://localhost/LMS/src/php/goalsres.php', {params: {empid: eid}})
            .then((result) => {
...
useEffect(() => {
    ...
    var eid = localStorage.getItem('empID');
    axios.get('http://localhost/LMS/src/php/achievements.php',{params:{empid:eid}})
    .then((result) =>{
...
const edit = (e) =>{
    ...
    axios.post('http://localhost/LMS/src/php/goaledit.php',sendData)
        .then((result) => {
...
const acc = (e) =>{
    ...
    axios.post('http://localhost/LMS/src/php/achievement.php',sendData)
        .then((result) => {
          if(result.data['data']['State'] ==   'Inserted'){
        //   alert("Goal Updated");
        }else{
...
axios.post('http://localhost/LMS/src/php/goal2achiv.php', sendData)
        .then((result) => {
...
useEffect(() => {
    ...
    axios.get('http://localhost/LMS/src/php/teamupdates.php',{params:{mname:name}})
    .then((result) =>{
...
const addreview = (e) => {
    ...
    const sendData = {
        ...
        axios.post('http://localhost/LMS/src/php/addreview.php',sendData)
        .then((result) => {
