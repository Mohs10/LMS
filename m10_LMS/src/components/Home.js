...
const leaveType = (lcnt) => {
    if (lcnt.TypeOfLeave == "PL") {
       return 18-lcnt.noofLeaves
    } else if (lcnt.TypeOfLeave == "SL") {
       return 15 -lcnt.noofLeaves
    } else if (lcnt.TypeOfLeave == "CL") {
        return 6 -lcnt.noofLeaves
    }else if (lcnt.TypeOfLeave == "ML") {
        return 182 -lcnt.noofLeaves
    }else if (lcnt.TypeOfLeave == "PAL") {
        return 15 -lcnt.noofLeaves
    }else if (lcnt.TypeOfLeave == "EL") {
        return 1 -lcnt.noofLeaves
    }else if (lcnt.TypeOfLeave == "BRL") {
        return 2 -lcnt.noofLeaves
    }else {
      return  lcnt.noofLeaves
    }
}
